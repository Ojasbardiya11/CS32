...
void order(string a[], int n)
{
    ...
    int firstGreater = n;
    int divide = n/2;
    separate(a, n, a[divide], firstNotLess, firstGreater); //Divide the array w.r.t the middle element
    order(a, firstNotLess); // recursively sort the left half of the array
    order(a + firstGreater, n - firstGreater); // recursively sort the right half of the array
}
