...
//  Homework4part1
//
//  Created by Ojas Bardiya on 5/28/19.
...
void insertion_sort(vector<Sensor>& s, bool comp(const Sensor&, const Sensor&))
{
    ...
    // edition and messed it up.  See the errata page entry for page 313
...
int main()
{
    ...
    // destruction time.
    {
        ...
        {
            Sensor* currentS = &auxSensors[i];
            sensorptrs.push_back(currentS);
        }
